                ...
                new SharedElementCallback() {
                    ...
                    public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
                        ...
                        Toast.makeText(getActivity().getApplicationContext(),
                                "👻 setEnterSharedElementCallback()" +
                                        " thisFragment: " + thisFragment.getClass().getSimpleName(), Toast.LENGTH_SHORT).show();

                        String nameBefore = names.get(0);
                        View viewBefore = sharedElements.get(nameBefore);
                        ...
                        View viewAfter = view.findViewById(R.id.image);

                        // Map the first shared element name to the child ImageView.
                        sharedElements.put(names.get(0), viewAfter);
