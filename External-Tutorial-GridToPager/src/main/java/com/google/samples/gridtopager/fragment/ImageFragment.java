...
//                        Toast.makeText(view.getContext(), "ImageFragment onLoadFailed()" +
//                                " imageRes: " + imageRes, Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(view.getContext(), "ImageFragment onResourceReady()" +
//                                " imageRes: " + imageRes, Toast.LENGTH_SHORT).show();
